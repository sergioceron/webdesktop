 ...
 */
package com.dotrow.projects.webdesktop.client;
...
import com.dotrow.projects.webdesktop.client.explorer.ExplorerController;
import com.dotrow.projects.webdesktop.client.explorer.ExplorerEvents;
...
import resources.src.com.extjs.gxt.samples.resources.client.TestData;
import resources.src.com.extjs.gxt.samples.resources.client.model.Stock;
...
public class MainEntryPoint implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    FileSystemServiceAsync service = (FileSystemServiceAsync) GWT.create(FileSystemService.class);
    ServiceDefTarget endpoint = (ServiceDefTarget) service;
    String moduleRelativeURL = GWT.getModuleBaseURL()  + KernelServices.FS_SERVICE;
    endpoint.setServiceEntryPoint(moduleRelativeURL);
    Registry.register(KernelServices.FS_SERVICE, service);

    Dispatcher dispatcher = Dispatcher.get();
    dispatcher.addController(new ExplorerController());

    AppEvent ae = new AppEvent(ExplorerEvents.OPEN);
    ae.setData("desktop",desktop);
